...
from tgedr.nihao.s3.s3 import Parquet2PdDataFrameS3Source, PdDataFrameS3Sink, S3Connector
...
def test_s3_sink_put(aws_credentials):
    ...
    df = DataFrame(
        {
            "symbol": { 0: "XPTO",},
            "variable": { 0: ("Adj Close", "AMZN"),},
            "value": { 0: 0.09791699796915054,},
            "actual_time": { 0: 863654400.0,},
        }
    )
